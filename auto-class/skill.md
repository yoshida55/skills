...
### 基本ルール
```
原則: [section]_[element]          (2単語・これが基本)
最終手段: [section]_[element]_[detail] (3単語・本当に必要なときだけ)

例：
✅ header_title (2単語 - 基本形)
✅ header_item_title (3単語 - 2単語では区別できないときだけ)
❌ header_item_title_active (4単語 - 絶対禁止)
```

### 使い分け
- **2単語が原則**: まず2単語で命名できないか考える。できるなら必ず2単語にする
- **3単語は最終手段**: 2単語で区別できない・意味が伝わらない場合のみ使う。迷ったら2単語
